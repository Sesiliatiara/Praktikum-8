...
<html>
    ...
    <body>
      <center><h3>FORMULIR PESERTA DIDIK</h3></center> <br>
      <h>Tanggal : <input type = "text" name = "tanggal"></h>
        <?php 
        $error_nis ="";
        $error_jp="";
        $error_tanggal="";
  ...
  <div class="form-group row">
    <div class="col-sm-10">
    <button type="submit" name="Submit" class="btn btn-primary" style="background-color:lightgreen; color:black;">Submit</button>
     <button type="next" name="next" class="btn btn-primary" style="background-color:yellow;"><a href="dataDiri.php" style="color:black;">Next</button>
    </div>
  </div>
